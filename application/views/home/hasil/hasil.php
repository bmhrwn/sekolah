                ...
                <div class="toggole-boxs">
                    ...
                    <div>
                        ...
                        <?php } else if ($data_pendaftaran['status_pemberitahuan'] == 2) { ?>
                            <p> <b>Segera!</b> datang ke sekolah pada tanggal <b> <?= date('d F Y', strtotime($check_jadwal['jadwal'])) ?> </b> Jam <b> <?= $data_pendaftaran['jam'] ?></b> untuk mengikuti tes tertulis dan wawancara. <br> Jika calon siswa tidak mengikuti tes tertulis pada jadwal yang telah ditentukan maka calon siswa dianggap <b>gagal</b>.</p>
                        <?php } else { ?>
                            <p> Sudah melakukan test dan wawancara pada tanggal <b> <?= date('d F Y', strtotime($check_jadwal['jadwal'])) ?> </b> Jam <b> <?= $data_pendaftaran['jam'] ?></b> </p>
                        <?php } ?>
                    </div>
                    ...
                    <div>
                        ...
                        <?php } else if ($data_pendaftaran['status_pemberitahuan'] == 3) { ?>
                            <p>Hasil Tes tertulis dan Wawancara telah keluar, Silahkan Tunggu pemberitahuan akhir dari kami.</p>
                        <?php } else { ?>
                            <p><?= $data_pendaftaran['pemberitahuan'] ?></p>
