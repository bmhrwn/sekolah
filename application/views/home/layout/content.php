        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-4">
                ...
                <div class="service-box wow fadeInUp" data-wow-delay="0.6s">
                    ...
                    <h4>Menunggu Konfirmasi Pendaftaran</h4>
                    <p>Setelah mengisi formulir calon siswa menunggu konfirmasi pendaftaran.</p>
                </div>
                <div class="space-60"></div>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4">
                ...
                <div class="service-box wow fadeInUp" data-wow-delay="0.4s">
                    ...
                    <h4>Menunggu Hasil Pengumuman</h4>
                    <p>Setelah melakukan tes tertulis potensi akademik, calon siswa menunggu hasil pengumuman.</p>
                </div>
                <div class="space-60"></div>
                <div class="service-box wow fadeInUp" data-wow-delay="0.6s">
                    <div class="box-icon">
                    ...
                    <h4>Melakukan Daftar Ulang</h4>
                    <p>Calon siswa melakukan daftar ulang dengan mendatangi langsung ke sekolah.</p>
                </div>
                <div class="space-60"></div>
            </div>
        </div>
